...
=======
Qustion: How much time does it takes to run the algorithm for n = 500 objects?
>>>>>>> 7189790de1190b7117c966b2150f01d78755d9dc

```{r Dynamic programing, cache=TRUE}
n <- 2000
knapsack_objects <- data.frame(
  w = sample(1:4000, size = n, replace = TRUE),
  v = runif(n = n, 0, 10000)
...
system.time(
  result_500 <- knapsack_dynamic(knapsack_objects[1:500, ], W = 2000)
)

```

For n = 500 objects and a capacity of W = 2000, the algorithm completes in 
roughly 2–3 seconds on my Macbook laptop.
